...
class PongGame(Widget):
    ...
    def update(self, dt):
        ...
        padelPos[0] = self.player1.center_y

    def on_touch_move(self, touch):
        #you can only move player 1 by clicking on it
